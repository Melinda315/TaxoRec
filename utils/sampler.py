...
def sample_function(adj_train, num_nodes, batch_size, n_negative, result_queue):
    ...
    print(user_item_pairs[0])
    print(item_user_pairs[0])
    ...
    while True:
        for i in range(int(len(user_item_pairs) / batch_size)):
            ...
            result_queue.put(torch.from_numpy(user_triples))
...
class WarpSampler(object):
    ...
    def __init__(self, num_nodes, user_item_matrix, batch_size=10000, n_negative=10, n_workers=1):
